#define PROGRAM_NAME "mdns-app-airplayreg-appletv"
...
typedef struct {
	...
	mdns_string_t deviceinfo_instance;
...
service_callback(int sock, const struct sockaddr* from, size_t addrlen, mdns_entry_type_t entry,
	...
	if ((name.length == (sizeof(dns_sd) - 1)) &&
		...
		if ((rtype == MDNS_RECORDTYPE_PTR) || (rtype == MDNS_RECORDTYPE_ANY)) {
			...
			additional[additional_count++] = service->txt_record[6];
			additional[additional_count++] = service->txt_record[7];
			additional[additional_count++] = service->txt_record[8];
			additional[additional_count++] = service->txt_record[9];
			additional[additional_count++] = service->txt_record[10];
			additional[additional_count++] = service->txt_record[11];
			additional[additional_count++] = service->txt_record[12];
			additional[additional_count++] = service->txt_record[13];
			additional[additional_count++] = service->txt_record[14];
			additional[additional_count++] = service->txt_record[15];
			additional[additional_count++] = service->txt_record[16];
			additional[additional_count++] = service->txt_record[17];
...
service_mdns(const char* hostname, const char* service_name, int service_port) {
	...
	service.service_instance = service_instance_string;				// CN-hxs-macmini._airplay._tcp.local.
	service.hostname_qualified = hostname_qualified_string;			// CN-hxs-macmini.local.
	...
	service.txt_record[0] = (mdns_record_t){.name = service.service_instance,
	                                        ...
	                                        .data.txt.key = {MDNS_STRING_CONST("acl")},				//Access ControL. 0,1,2 == anon,users,admin(?)
	                                        .data.txt.value = {MDNS_STRING_CONST("0")},
	                                        .rclass = 0,
	                                        .ttl = 0};
	service.txt_record[1] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("deviceid")},		//device MAC addr
	                                        .data.txt.value = {MDNS_STRING_CONST("C2:DF:EB:C6:A7:27")},
	                                        .rclass = 0,
	                                        .ttl = 0};
	...
	service.txt_record[3] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("features")},		//Features, aka ft - see Feat class.
	                                        .data.txt.value = {MDNS_STRING_CONST("0x4A7FCFD5,0x38174FDE")},
	                                        .rclass = 0,
	                                        .ttl = 0};
	service.txt_record[4] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("flags")},			//flags (bitmask)
	                                        .data.txt.value = {MDNS_STRING_CONST("0x4")},
	                                        .rclass = 0,
	                                        .ttl = 0};
	service.txt_record[5] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("gid")},				//Group UUID (generated casually)
	...
	service.txt_record[6] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("igl")},
	                                        .data.txt.value = {MDNS_STRING_CONST("0")},
	                                        .rclass = 0,
	                                        .ttl = 0};
	service.txt_record[7] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("gcgl")},		//Group Contains Group Leader.
	                                        .data.txt.value = {MDNS_STRING_CONST("0")},
	                                        .rclass = 0,
	                                        .ttl = 0};
	...
	service.txt_record[9] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("at")},
	                                        .data.txt.value = {MDNS_STRING_CONST("4")},
	                                        .rclass = 0,
	                                        .ttl = 0};
	service.txt_record[10] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("protovers")},
	                                        .data.txt.value = {MDNS_STRING_CONST("1.1")},
	                                        .rclass = 0,
	                                        .ttl = 0};
	service.txt_record[11] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("pi")},				// Pairing UUID (generated casually)
	                                        .data.txt.value = {MDNS_STRING_CONST("bcd62156-13eb-4b21-8876-0c2ff0c5bf19")},
	                                        .rclass = 0,
	                                        .ttl = 0};		
	...
	service.txt_record[13] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("pk")},				// RAOP: Ed25519 PubKey
	...
	service.txt_record[14] = (mdns_record_t){.name = service.service_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("srcvers")},				//Source Version (airplay SDK?): absence triggers AP1 ANNOUNCE behaviour.
	...
	service.txt_record[17] = (mdns_record_t){.name = service.deviceinfo_instance,
	                                        .type = MDNS_RECORDTYPE_TXT,
	                                        .data.txt.key = {MDNS_STRING_CONST("icolor")},
	                                        .data.txt.value = {MDNS_STRING_CONST("0")},
	                                        .rclass = 0,
	                                        .ttl = 0};	
...
main(int argc, const char* const* argv) {
	printf("mDNS service register - DEMO - Apple Airplay("PROGRAM_NAME")\n");
	int mode = 2;
	...
	for (int iarg = 0; iarg < argc; ++iarg) {
		if ((strcmp(argv[iarg], "--help") == 0) || (strcmp(argv[iarg], "-h") == 0)) {
			printf(" |    Function:   (DEMO) Register and broadcast your service(Apple Airplay) to the network. (1.0.1)\n");
			printf(" |   Mechanism:   Register \"instancename._airplay._tcp.local\" and reply request from other devices.\n");
			printf(" |                Ready to answer [PTR,SRV,A,AAAA] records on demand.\n");
			printf(" |                If TXT records are need, it is recommended to use \"mdns-reg-txt\" tool.\n");
			printf(" |       Usage:   \""PROGRAM_NAME" <servicename._tcp.domain> <instancename> <port>\"\n");
			printf(" |     Example:   \""PROGRAM_NAME" _airplay._tcp.local. myprinter 631\"\n");
			return 1;
		}
	}
	if (argc>1){
		printf("Invalid command. \""PROGRAM_NAME" -h\" for help\n\n");
		return 2;
	}
	// start
